...
<xsl:stylesheet version="1.0"
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'">Colección</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'">Libro</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'">
 <xsl:choose>
 <xsl:when test="substring($controlField008,22,1)!='m'">Recurso continuo</xsl:when>
 ...
 <xsl:when test="$materialTypeLabel='Music'">Album de Música</xsl:when>
 ...
 <xsl:attribute name="resource">#registro</xsl:attribute>
 ...
 <span class="results_summary type"><span class="label">Tipo de material: </span>
 ...
 <span class="results_summary volumes"><span class="label">Volumen: </span>
 <a>
 <xsl:choose>
 <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
 ...
 <span class="results_summary set"><span class="label">Colección: </span>
 ...
 <xsl:with-param name="class">results_summary edición</xsl:with-param>
 ...
 <span class="label">Tipo de medio: </span>
 ...
 <span class="label">Tipo de portador: </span>
 ...
 <span class="label">Número de informe: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0"> [Parte del título]</xsl:when>
 <xsl:when test="@ind2=1"> [Título paralelo]</xsl:when>
 <xsl:when test="@ind2=2"> [Titulo distintivo]</xsl:when>
 <xsl:when test="@ind2=3"> [Otro título]</xsl:when>
 <xsl:when test="@ind2=4"> [Título de cubierta]</xsl:when>
 <xsl:when test="@ind2=5"> [Título agregado]</xsl:when>
 <xsl:when test="@ind2=6"> [Título de leyenda]</xsl:when>
 <xsl:when test="@ind2=7"> [Título abreviado]</xsl:when>
 <xsl:when test="@ind2=8"> [Titulo de lomo]</xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <span class="results_summary related_works"><span class="label">Trabajos relacionados: </span>
 ...
 <span class="results_summary contained_works"><span class="label">Trabajos contenidos: </span>
 ...
 <span class="results_summary subjects"><span class="label">Materia(s): </span>
 ...
 <span class="results_summary genre"><span class="label">Género/Forma: </span>
...
<!-- DDC classification -->
 ...
 <span class="label">Clasificación CDD: </span>
...
<!-- Image processing code added here, takes precedence over text links including y3z text -->
 ...
 <span class="label">Créditos de producción: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind1=0"><xsl:text>Materia: </xsl:text></xsl:when>
 <xsl:when test="@ind1=1"><xsl:text>Revisión: </xsl:text></xsl:when>
 <xsl:when test="@ind1=2"><xsl:text>Alcance y contenido: </xsl:text></xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0">
 <span class="label">Es continuación de:</span>
 </xsl:when>
 <xsl:when test="@ind2=1">
 <span class="label">En parte es continuación de:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">Reemplaza:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Reemplaza en parte:</span>
 </xsl:when>
 ...
 <xsl:when test="@ind2=1">
 <span class="label">Continúa en parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">Reemplazado por:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Reemplazado en parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">Absorbido por:</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">Absorbida en parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">Dividido en .. y ...:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">Combinar con ... para formar ...</span>
 </xsl:when>
 <xsl:when test="@ind2=8">
 ...
 <!-- #13383 -->
 <xsl:when test="@tag&lt;700">Por: </xsl:when>
 <!--#13382 Changed Additional author to contributor -->
 <xsl:otherwise>Colaborador(es): </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Music'"><xsl:attribute name="property">por Artista</xsl:attribute></xsl:when>
 <xsl:otherwise><xsl:attribute name="property">autor</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="property">contribuidor</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 <xsl:when test="substring(@tag, 2, 1)='0'">
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Music'"><xsl:attribute name="typeof">GrupoMusical</xsl:attribute></xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">Persona</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">Institución</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <span property="name">
 <xsl:choose>
