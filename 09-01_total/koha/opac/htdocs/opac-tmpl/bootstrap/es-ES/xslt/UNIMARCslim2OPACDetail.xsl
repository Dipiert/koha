...
<xsl:template match="marc:record">
 ...
 <xsl:with-param name="spanclass">coautor</xsl:with-param>
 </xsl:call-template>
 ...
 <xsl:with-param name="spanclass">edición</xsl:with-param>
 </xsl:call-template>
 ...
 <span class="label">Nota de contenidos: </span>
 ...
 <span class="label">Nota de procedencia: </span>
 ...
 <span class="label">Bibliografía: </span>
 ...
 <span class="label">Historial SUDOC de publicación periódica: </span>
 ...
 <xsl:with-param name="label">Materia - Nombre personal</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">601</xsl:with-param>
 <xsl:with-param name="label">Materia - Autor institucional</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">602</xsl:with-param>
 <xsl:with-param name="label">Materia - Familia</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">604</xsl:with-param>
 <xsl:with-param name="label">Materia - Autor/título</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">606</xsl:with-param>
 <xsl:with-param name="label">Materia - Nombre de temático</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">607</xsl:with-param>
 <xsl:with-param name="label">Materia - Nombre geográfico</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">608</xsl:with-param>
 <xsl:with-param name="label">Materia - Forma</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">610</xsl:with-param>
 <xsl:with-param name="label">Materia</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_subject">
 <xsl:with-param name="tag">615</xsl:with-param>
 <xsl:with-param name="label">Categoría de materia</xsl:with-param>
 </xsl:call-template>
